...
describe('Tests for channelsCreateV1', () => {
	test('Testing creating channels', () => {
		...
		expect(typeof authUserId).toBe('object');
		...
		expect(typeof channelId).toBe('object');
		expect(typeof channelId2).toBe('object');
		expect(typeof channelId3).toBe('object');
	}); 
	...
	test('Testing error in creating channels by having no names or more than 20 characters', () => {
		...
		const channelId_d = channelsCreateV1(authUserId, 'name', 'what');
