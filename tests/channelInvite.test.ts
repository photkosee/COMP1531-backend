...
test('Tests for successful invite - channel/invite/v2', () => {
  ...
  const channel1 = JSON.parse(String(res.getBody()));
  ...
  const inviteResponse1 = JSON.parse(String(res.getBody()));
  ...
  let channel1Details = JSON.parse(String(res.getBody()));
  ...
  const user1Profile = JSON.parse(String(res.getBody()));
  res = request('GET', `${url}:${port}/user/profile/v2`, {
    json: {
  ...
  const user2Profile = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  channel1Details = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const invite1 = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const invite2 = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const invite3 = JSON.parse(String(res.getBody()));
...
test('Testing with valid ChannelId and invalid uId', () => {
  ...
  expect(res.statusCode).toBe(OK);
  const channelInviteResponse = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const channelInviteResponse1 = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const channelInviteResponse2 = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const channelInviteResponse3 = JSON.parse(String(res.getBody()));
  expect(channelInviteResponse2).toStrictEqual(ERROR);
  res = post('channel/invite/v2', {
    json: {
      token: 0.1,
  ...
  expect(res.statusCode).toBe(OK);
  const channelInviteResponse4 = JSON.parse(String(res.getBody()));
  expect(channelInviteResponse2).toStrictEqual(ERROR);
...
test('Testing for invalid channel', () => {
  ...
  expect(res.statusCode).toBe(OK);
  const channelInvite1 = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const channelInvite2 = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const channelInvite3 = JSON.parse(String(res.getBody()));
  ...
  expect(res.statusCode).toBe(OK);
  const channelInvite4 = JSON.parse(String(res.getBody()));
